    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background-color: #1A3A2A; color: #F0F0E0; padding: 20px; border-radius: 8px; text-align: center;">
          <h1 style="margin: 0; color: #FFBF00;">Countpluse</h1>
        ...
        <div style="padding: 20px; background-color: #f5f5f5; border-radius: 8px; margin-top: 20px;">
          ...
          <p style="color: #666; font-size: 14px; line-height: 1.6;">
            Thank you for registering with Countpluse! To complete your registration and verify your email, 
        ...
        <div style="text-align: center; margin-top: 20px; color: #999; font-size: 12px;">
          <p>If you didn't register for Countpluse, please ignore this email.</p>
          <p>&copy; 2026 Countpluse. All rights reserved.</p>
        </div>
      </div>
    `,
  };
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="padding: 20px; background-color: #f5f5f5; border-radius: 8px; margin-top: 20px;">
          <p style="color: #333; font-size: 16px;">Hello <strong>${user.name}</strong>,</p>
          <p style="color: #666; font-size: 14px; line-height: 1.6;">
            Click the button below to securely log in to your Countpluse account.
          </p>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="padding: 20px; background-color: #f5f5f5; border-radius: 8px; margin-top: 20px;">
          ...
          <p style="color: #666; font-size: 14px; line-height: 1.6;">
            Use the OTP code below to verify your Countpluse account.
          </p>
